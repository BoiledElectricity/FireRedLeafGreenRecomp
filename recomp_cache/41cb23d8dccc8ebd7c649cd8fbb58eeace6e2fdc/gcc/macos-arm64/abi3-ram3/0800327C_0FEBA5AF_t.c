...
// function 0x0800327C mode=thumb end=0x08003298
...
OVL_EXPORT void func_0800327C(void) {
    if (g_runtime_fn_entry_hook) g_runtime_fn_entry_hook(0x0800327Cu);
    /* 0800327C  0800327c T str r1,[r13,#0x60] */
    g_cpu.R[15] = 0x0800327Cu;
    if (runtime_should_yield()) return;
    if (g_runtime_insn_trace) runtime_insn_fp();
    uint32_t _cyc_0800327C = 1u;
    _cyc_0800327C = 1u;
    uint32_t _base_0800327C = g_cpu.R[13];
    uint32_t _off_0800327C;
    _off_0800327C = 0x00000060u;
    uint32_t _ea_0800327C = _base_0800327C + _off_0800327C;
    uint32_t _post_0800327C = _base_0800327C + _off_0800327C;
    _cyc_0800327C += runtime_mem_cycles(_ea_0800327C, 4u, 0u);
    runtime_trace_event(RUNTIME_TRACE_MEM_WRITE, 0x0800327Cu, _ea_0800327C & ~3u, g_cpu.R[1], 4u);
    bus_write_u32(_ea_0800327C & ~3u, g_cpu.R[1]);
    g_cpu.R[15] = 0x0800327Eu;
    runtime_tick(_cyc_0800327C);
    /* 0800327E  0800327e T adds r2,r2,#0x1 */
    g_cpu.R[15] = 0x0800327Eu;
    if (runtime_should_yield()) return;
    if (g_runtime_insn_trace) runtime_insn_fp();
    uint32_t _cyc_0800327E = 1u;
    _cyc_0800327E = 1u;
    uint32_t _rn_0800327E = g_cpu.R[2];
    uint32_t _r_0800327E;
    _r_0800327E = _rn_0800327E + 0x00000001u;
    arm_set_nzcv_add(_rn_0800327E, 0x00000001u, _r_0800327E);
    g_cpu.R[2] = _r_0800327E;
    g_cpu.R[15] = 0x08003280u;
    runtime_tick(_cyc_0800327E);
    /* 08003280  08003280 T str r2,[r13,#0x58] */
    g_cpu.R[15] = 0x08003280u;
    if (runtime_should_yield()) return;
    if (g_runtime_insn_trace) runtime_insn_fp();
    uint32_t _cyc_08003280 = 1u;
    _cyc_08003280 = 1u;
    uint32_t _base_08003280 = g_cpu.R[13];
    uint32_t _off_08003280;
    _off_08003280 = 0x00000058u;
    uint32_t _ea_08003280 = _base_08003280 + _off_08003280;
    uint32_t _post_08003280 = _base_08003280 + _off_08003280;
    _cyc_08003280 += runtime_mem_cycles(_ea_08003280, 4u, 0u);
    runtime_trace_event(RUNTIME_TRACE_MEM_WRITE, 0x08003280u, _ea_08003280 & ~3u, g_cpu.R[2], 4u);
    bus_write_u32(_ea_08003280 & ~3u, g_cpu.R[2]);
    g_cpu.R[15] = 0x08003282u;
    runtime_tick(_cyc_08003280);
    /* 08003282  08003282 T adds r1,r0,#0x1 */
    g_cpu.R[15] = 0x08003282u;
    if (runtime_should_yield()) return;
    if (g_runtime_insn_trace) runtime_insn_fp();
    uint32_t _cyc_08003282 = 1u;
    _cyc_08003282 = 1u;
    uint32_t _rn_08003282 = g_cpu.R[0];
    uint32_t _r_08003282;
    _r_08003282 = _rn_08003282 + 0x00000001u;
    arm_set_nzcv_add(_rn_08003282, 0x00000001u, _r_08003282);
    g_cpu.R[1] = _r_08003282;
    g_cpu.R[15] = 0x08003284u;
    runtime_tick(_cyc_08003282);
    /* 08003284  08003284 T str r1,[r13,#0x5c] */
    g_cpu.R[15] = 0x08003284u;
    if (runtime_should_yield()) return;
    if (g_runtime_insn_trace) runtime_insn_fp();
    uint32_t _cyc_08003284 = 1u;
    _cyc_08003284 = 1u;
    uint32_t _base_08003284 = g_cpu.R[13];
    uint32_t _off_08003284;
    _off_08003284 = 0x0000005Cu;
    uint32_t _ea_08003284 = _base_08003284 + _off_08003284;
    uint32_t _post_08003284 = _base_08003284 + _off_08003284;
    _cyc_08003284 += runtime_mem_cycles(_ea_08003284, 4u, 0u);
    runtime_trace_event(RUNTIME_TRACE_MEM_WRITE, 0x08003284u, _ea_08003284 & ~3u, g_cpu.R[1], 4u);
    bus_write_u32(_ea_08003284 & ~3u, g_cpu.R[1]);
    g_cpu.R[15] = 0x08003286u;
    runtime_tick(_cyc_08003284);
