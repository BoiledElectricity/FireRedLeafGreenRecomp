...
// function 0x0800329A mode=thumb end=0x080032EA
...
OVL_EXPORT void func_0800329A(void) {
    if (g_runtime_fn_entry_hook) g_runtime_fn_entry_hook(0x0800329Au);
    /* 0800329A  0800329a T movs r3,r0,lsl #1 */
    g_cpu.R[15] = 0x0800329Au;
    if (runtime_should_yield()) return;
    if (g_runtime_insn_trace) runtime_insn_fp();
    uint32_t _cyc_0800329A = 1u;
    _cyc_0800329A = 1u;
    uint32_t _rm_0800329A = g_cpu.R[0];
    uint32_t _op2_0800329A;
    uint32_t _co_0800329A;
    _op2_0800329A = _rm_0800329A << 1;
    _co_0800329A = (_rm_0800329A >> 31) & 1u;
    uint32_t _r_0800329A;
    _r_0800329A = _op2_0800329A;
    arm_set_nzc_logic(_r_0800329A, _co_0800329A);
    g_cpu.R[3] = _r_0800329A;
    g_cpu.R[15] = 0x0800329Cu;
    runtime_tick(_cyc_0800329A);
    /* 0800329C  0800329c T adds r3,r3,r0 */
    g_cpu.R[15] = 0x0800329Cu;
    if (runtime_should_yield()) return;
    if (g_runtime_insn_trace) runtime_insn_fp();
    uint32_t _cyc_0800329C = 1u;
    _cyc_0800329C = 1u;
    uint32_t _rm_0800329C = g_cpu.R[0];
    uint32_t _op2_0800329C;
    uint32_t _co_0800329C;
    _op2_0800329C = _rm_0800329C;
    _co_0800329C = cpsr_c();
    uint32_t _rn_0800329C = g_cpu.R[3];
    uint32_t _r_0800329C;
    _r_0800329C = _rn_0800329C + _op2_0800329C;
    arm_set_nzcv_add(_rn_0800329C, _op2_0800329C, _r_0800329C);
    g_cpu.R[3] = _r_0800329C;
    g_cpu.R[15] = 0x0800329Eu;
    runtime_tick(_cyc_0800329C);
    /* 0800329E  0800329e T movs r3,r3,lsl #2 */
    g_cpu.R[15] = 0x0800329Eu;
    if (runtime_should_yield()) return;
    if (g_runtime_insn_trace) runtime_insn_fp();
    uint32_t _cyc_0800329E = 1u;
    _cyc_0800329E = 1u;
    uint32_t _rm_0800329E = g_cpu.R[3];
    uint32_t _op2_0800329E;
    uint32_t _co_0800329E;
    _op2_0800329E = _rm_0800329E << 2;
    _co_0800329E = (_rm_0800329E >> 30) & 1u;
    uint32_t _r_0800329E;
    _r_0800329E = _op2_0800329E;
    arm_set_nzc_logic(_r_0800329E, _co_0800329E);
    g_cpu.R[3] = _r_0800329E;
    g_cpu.R[15] = 0x080032A0u;
    runtime_tick(_cyc_0800329E);
    /* 080032A0  080032a0 T mov r1,r12 */
    g_cpu.R[15] = 0x080032A0u;
    if (runtime_should_yield()) return;
    if (g_runtime_insn_trace) runtime_insn_fp();
    uint32_t _cyc_080032A0 = 1u;
    _cyc_080032A0 = 1u;
    uint32_t _rm_080032A0 = g_cpu.R[12];
    uint32_t _op2_080032A0;
    uint32_t _co_080032A0;
    _op2_080032A0 = _rm_080032A0;
    _co_080032A0 = cpsr_c();
    uint32_t _r_080032A0;
    _r_080032A0 = _op2_080032A0;
    g_cpu.R[1] = _r_080032A0;
    g_cpu.R[15] = 0x080032A2u;
    runtime_tick(_cyc_080032A0);
    /* 080032A2  080032a2 T adds r1,r1,#0x8 */
    g_cpu.R[15] = 0x080032A2u;
    if (runtime_should_yield()) return;
    if (g_runtime_insn_trace) runtime_insn_fp();
    uint32_t _cyc_080032A2 = 1u;
    _cyc_080032A2 = 1u;
    uint32_t _rn_080032A2 = g_cpu.R[1];
    uint32_t _r_080032A2;
    _r_080032A2 = _rn_080032A2 + 0x00000008u;
    arm_set_nzcv_add(_rn_080032A2, 0x00000008u, _r_080032A2);
    g_cpu.R[1] = _r_080032A2;
    g_cpu.R[15] = 0x080032A4u;
    runtime_tick(_cyc_080032A2);
    /* 080032A4  080032a4 T adds r1,r3,r1 */
    g_cpu.R[15] = 0x080032A4u;
    if (runtime_should_yield()) return;
    if (g_runtime_insn_trace) runtime_insn_fp();
    uint32_t _cyc_080032A4 = 1u;
    _cyc_080032A4 = 1u;
    uint32_t _rm_080032A4 = g_cpu.R[1];
    uint32_t _op2_080032A4;
    uint32_t _co_080032A4;
    _op2_080032A4 = _rm_080032A4;
    _co_080032A4 = cpsr_c();
    uint32_t _rn_080032A4 = g_cpu.R[3];
    uint32_t _r_080032A4;
    _r_080032A4 = _rn_080032A4 + _op2_080032A4;
    arm_set_nzcv_add(_rn_080032A4, _op2_080032A4, _r_080032A4);
    g_cpu.R[1] = _r_080032A4;
    g_cpu.R[15] = 0x080032A6u;
    runtime_tick(_cyc_080032A4);
    /* 080032A6  080032a6 T movs r2,r4,asr #1 */
    g_cpu.R[15] = 0x080032A6u;
    if (runtime_should_yield()) return;
    if (g_runtime_insn_trace) runtime_insn_fp();
    uint32_t _cyc_080032A6 = 1u;
    _cyc_080032A6 = 1u;
    uint32_t _rm_080032A6 = g_cpu.R[4];
    uint32_t _op2_080032A6;
    uint32_t _co_080032A6;
    _op2_080032A6 = (uint32_t)((int32_t)_rm_080032A6 >> 1);
    _co_080032A6 = (_rm_080032A6 >> 0) & 1u;
    uint32_t _r_080032A6;
    _r_080032A6 = _op2_080032A6;
    arm_set_nzc_logic(_r_080032A6, _co_080032A6);
    g_cpu.R[2] = _r_080032A6;
    g_cpu.R[15] = 0x080032A8u;
    runtime_tick(_cyc_080032A6);
    /* 080032A8  080032a8 T movs r0,#0x3 */
    g_cpu.R[15] = 0x080032A8u;
    if (runtime_should_yield()) return;
    if (g_runtime_insn_trace) runtime_insn_fp();
    uint32_t _cyc_080032A8 = 1u;
    _cyc_080032A8 = 1u;
    uint32_t _r_080032A8;
    _r_080032A8 = 0x00000003u;
    arm_set_nzc_logic(_r_080032A8, cpsr_c());
    g_cpu.R[0] = _r_080032A8;
    g_cpu.R[15] = 0x080032AAu;
    runtime_tick(_cyc_080032A8);
    /* 080032AA  080032aa T ands r2,r2,r0 */
    g_cpu.R[15] = 0x080032AAu;
    if (runtime_should_yield()) return;
    if (g_runtime_insn_trace) runtime_insn_fp();
    uint32_t _cyc_080032AA = 1u;
    _cyc_080032AA = 1u;
    uint32_t _rm_080032AA = g_cpu.R[0];
    uint32_t _op2_080032AA;
    uint32_t _co_080032AA;
    _op2_080032AA = _rm_080032AA;
    _co_080032AA = cpsr_c();
    uint32_t _rn_080032AA = g_cpu.R[2];
    uint32_t _r_080032AA;
    _r_080032AA = _rn_080032AA & _op2_080032AA;
    arm_set_nzc_logic(_r_080032AA, _co_080032AA);
    g_cpu.R[2] = _r_080032AA;
    g_cpu.R[15] = 0x080032ACu;
    runtime_tick(_cyc_080032AA);
    /* 080032AC  080032ac T ldr r1,[r1] */
    g_cpu.R[15] = 0x080032ACu;
    if (runtime_should_yield()) return;
    if (g_runtime_insn_trace) runtime_insn_fp();
    uint32_t _cyc_080032AC = 1u;
    _cyc_080032AC = 2u;
    uint32_t _base_080032AC = g_cpu.R[1];
    uint32_t _off_080032AC;
    _off_080032AC = 0x00000000u;
    uint32_t _ea_080032AC = _base_080032AC + _off_080032AC;
    uint32_t _post_080032AC = _base_080032AC + _off_080032AC;
    _cyc_080032AC += runtime_mem_cycles(_ea_080032AC, 4u, 0u);
    uint32_t _v_080032AC;
    { uint32_t _w = bus_read_u32(_ea_080032AC & ~3u); uint32_t _rot = (_ea_080032AC & 3u) * 8u; _v_080032AC = (_rot == 0u) ? _w : ((_w >> _rot) | (_w << (32u - _rot))); }
    g_cpu.R[1] = _v_080032AC;
    g_cpu.R[15] = 0x080032AEu;
    runtime_tick(_cyc_080032AC);
    /* 080032AE  080032ae T adds r1,r1,r2 */
    g_cpu.R[15] = 0x080032AEu;
    if (runtime_should_yield()) return;
    if (g_runtime_insn_trace) runtime_insn_fp();
    uint32_t _cyc_080032AE = 1u;
    _cyc_080032AE = 1u;
    uint32_t _rm_080032AE = g_cpu.R[2];
    uint32_t _op2_080032AE;
    uint32_t _co_080032AE;
    _op2_080032AE = _rm_080032AE;
    _co_080032AE = cpsr_c();
    uint32_t _rn_080032AE = g_cpu.R[1];
    uint32_t _r_080032AE;
    _r_080032AE = _rn_080032AE + _op2_080032AE;
    arm_set_nzcv_add(_rn_080032AE, _op2_080032AE, _r_080032AE);
    g_cpu.R[1] = _r_080032AE;
    g_cpu.R[15] = 0x080032B0u;
    runtime_tick(_cyc_080032AE);
    /* 080032B0  080032b0 T movs r0,r4,asr #3 */
    g_cpu.R[15] = 0x080032B0u;
    if (runtime_should_yield()) return;
    if (g_runtime_insn_trace) runtime_insn_fp();
    uint32_t _cyc_080032B0 = 1u;
    _cyc_080032B0 = 1u;
    uint32_t _rm_080032B0 = g_cpu.R[4];
    uint32_t _op2_080032B0;
    uint32_t _co_080032B0;
    _op2_080032B0 = (uint32_t)((int32_t)_rm_080032B0 >> 3);
    _co_080032B0 = (_rm_080032B0 >> 2) & 1u;
    uint32_t _r_080032B0;
    _r_080032B0 = _op2_080032B0;
    arm_set_nzc_logic(_r_080032B0, _co_080032B0);
    g_cpu.R[0] = _r_080032B0;
    g_cpu.R[15] = 0x080032B2u;
    runtime_tick(_cyc_080032B0);
    /* 080032B2  080032b2 T movs r0,r0,lsl #5 */
    g_cpu.R[15] = 0x080032B2u;
    if (runtime_should_yield()) return;
    if (g_runtime_insn_trace) runtime_insn_fp();
    uint32_t _cyc_080032B2 = 1u;
    _cyc_080032B2 = 1u;
    uint32_t _rm_080032B2 = g_cpu.R[0];
    uint32_t _op2_080032B2;
    uint32_t _co_080032B2;
    _op2_080032B2 = _rm_080032B2 << 5;
    _co_080032B2 = (_rm_080032B2 >> 27) & 1u;
    uint32_t _r_080032B2;
    _r_080032B2 = _op2_080032B2;
    arm_set_nzc_logic(_r_080032B2, _co_080032B2);
    g_cpu.R[0] = _r_080032B2;
    g_cpu.R[15] = 0x080032B4u;
    runtime_tick(_cyc_080032B2);
    /* 080032B4  080032b4 T adds r1,r1,r0 */
    g_cpu.R[15] = 0x080032B4u;
    if (runtime_should_yield()) return;
    if (g_runtime_insn_trace) runtime_insn_fp();
    uint32_t _cyc_080032B4 = 1u;
    _cyc_080032B4 = 1u;
    uint32_t _rm_080032B4 = g_cpu.R[0];
    uint32_t _op2_080032B4;
    uint32_t _co_080032B4;
    _op2_080032B4 = _rm_080032B4;
    _co_080032B4 = cpsr_c();
    uint32_t _rn_080032B4 = g_cpu.R[1];
    uint32_t _r_080032B4;
    _r_080032B4 = _rn_080032B4 + _op2_080032B4;
    arm_set_nzcv_add(_rn_080032B4, _op2_080032B4, _r_080032B4);
    g_cpu.R[1] = _r_080032B4;
    g_cpu.R[15] = 0x080032B6u;
    runtime_tick(_cyc_080032B4);
    /* 080032B6  080032b6 T add r3,r3,r12 */
    g_cpu.R[15] = 0x080032B6u;
    if (runtime_should_yield()) return;
    if (g_runtime_insn_trace) runtime_insn_fp();
    uint32_t _cyc_080032B6 = 1u;
    _cyc_080032B6 = 1u;
    uint32_t _rm_080032B6 = g_cpu.R[12];
    uint32_t _op2_080032B6;
    uint32_t _co_080032B6;
    _op2_080032B6 = _rm_080032B6;
    _co_080032B6 = cpsr_c();
    uint32_t _rn_080032B6 = g_cpu.R[3];
    uint32_t _r_080032B6;
    _r_080032B6 = _rn_080032B6 + _op2_080032B6;
    g_cpu.R[3] = _r_080032B6;
    g_cpu.R[15] = 0x080032B8u;
    runtime_tick(_cyc_080032B6);
    /* 080032B8  080032b8 T ldrb r0,[r3,#0x3] */
    g_cpu.R[15] = 0x080032B8u;
    if (runtime_should_yield()) return;
    if (g_runtime_insn_trace) runtime_insn_fp();
    uint32_t _cyc_080032B8 = 1u;
    _cyc_080032B8 = 2u;
    uint32_t _base_080032B8 = g_cpu.R[3];
    uint32_t _off_080032B8;
    _off_080032B8 = 0x00000003u;
    uint32_t _ea_080032B8 = _base_080032B8 + _off_080032B8;
    uint32_t _post_080032B8 = _base_080032B8 + _off_080032B8;
    _cyc_080032B8 += runtime_mem_cycles(_ea_080032B8, 1u, 0u);
    uint32_t _v_080032B8;
    _v_080032B8 = bus_read_u8(_ea_080032B8);
    g_cpu.R[0] = _v_080032B8;
    g_cpu.R[15] = 0x080032BAu;
    runtime_tick(_cyc_080032B8);
