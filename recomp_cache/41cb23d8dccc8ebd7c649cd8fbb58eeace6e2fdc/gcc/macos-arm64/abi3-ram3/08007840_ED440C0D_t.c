...
// function 0x08007840 mode=thumb end=0x0800785A
...
OVL_EXPORT void func_08007840(void) {
    if (g_runtime_fn_entry_hook) g_runtime_fn_entry_hook(0x08007840u);
    /* 08007840  08007840 T ldrb r0,[r0] */
    g_cpu.R[15] = 0x08007840u;
    if (runtime_should_yield()) return;
    if (g_runtime_insn_trace) runtime_insn_fp();
    uint32_t _cyc_08007840 = 1u;
    _cyc_08007840 = 2u;
    uint32_t _base_08007840 = g_cpu.R[0];
    uint32_t _off_08007840;
    _off_08007840 = 0x00000000u;
    uint32_t _ea_08007840 = _base_08007840 + _off_08007840;
    uint32_t _post_08007840 = _base_08007840 + _off_08007840;
    _cyc_08007840 += runtime_mem_cycles(_ea_08007840, 1u, 0u);
    uint32_t _v_08007840;
    _v_08007840 = bus_read_u8(_ea_08007840);
    g_cpu.R[0] = _v_08007840;
    g_cpu.R[15] = 0x08007842u;
    runtime_tick(_cyc_08007840);
