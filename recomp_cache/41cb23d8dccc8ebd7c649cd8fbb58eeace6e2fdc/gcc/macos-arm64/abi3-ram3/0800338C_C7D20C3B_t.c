...
// function 0x0800338C mode=thumb end=0x08003398
...
OVL_EXPORT void func_0800338C(void) {
    if (g_runtime_fn_entry_hook) g_runtime_fn_entry_hook(0x0800338Cu);
    /* 0800338C  0800338c T ldr r1,[r13,#0x14] */
    g_cpu.R[15] = 0x0800338Cu;
    if (runtime_should_yield()) return;
    if (g_runtime_insn_trace) runtime_insn_fp();
    uint32_t _cyc_0800338C = 1u;
    _cyc_0800338C = 2u;
    uint32_t _base_0800338C = g_cpu.R[13];
    uint32_t _off_0800338C;
    _off_0800338C = 0x00000014u;
    uint32_t _ea_0800338C = _base_0800338C + _off_0800338C;
    uint32_t _post_0800338C = _base_0800338C + _off_0800338C;
    _cyc_0800338C += runtime_mem_cycles(_ea_0800338C, 4u, 0u);
    uint32_t _v_0800338C;
    { uint32_t _w = bus_read_u32(_ea_0800338C & ~3u); uint32_t _rot = (_ea_0800338C & 3u) * 8u; _v_0800338C = (_rot == 0u) ? _w : ((_w >> _rot) | (_w << (32u - _rot))); }
    g_cpu.R[1] = _v_0800338C;
    g_cpu.R[15] = 0x0800338Eu;
    runtime_tick(_cyc_0800338C);
    /* 0800338E  0800338e T ldr r0,[r13,#0x18] */
    g_cpu.R[15] = 0x0800338Eu;
    if (runtime_should_yield()) return;
    if (g_runtime_insn_trace) runtime_insn_fp();
    uint32_t _cyc_0800338E = 1u;
    _cyc_0800338E = 2u;
    uint32_t _base_0800338E = g_cpu.R[13];
    uint32_t _off_0800338E;
    _off_0800338E = 0x00000018u;
    uint32_t _ea_0800338E = _base_0800338E + _off_0800338E;
    uint32_t _post_0800338E = _base_0800338E + _off_0800338E;
    _cyc_0800338E += runtime_mem_cycles(_ea_0800338E, 4u, 0u);
    uint32_t _v_0800338E;
    { uint32_t _w = bus_read_u32(_ea_0800338E & ~3u); uint32_t _rot = (_ea_0800338E & 3u) * 8u; _v_0800338E = (_rot == 0u) ? _w : ((_w >> _rot) | (_w << (32u - _rot))); }
    g_cpu.R[0] = _v_0800338E;
    g_cpu.R[15] = 0x08003390u;
    runtime_tick(_cyc_0800338E);
