...
// function 0x08003332 mode=thumb end=0x08003382
...
OVL_EXPORT void func_08003332(void) {
    if (g_runtime_fn_entry_hook) g_runtime_fn_entry_hook(0x08003332u);
    /* 08003332  08003332 T movs r3,r0,lsl #1 */
    g_cpu.R[15] = 0x08003332u;
    if (runtime_should_yield()) return;
    if (g_runtime_insn_trace) runtime_insn_fp();
    uint32_t _cyc_08003332 = 1u;
    _cyc_08003332 = 1u;
    uint32_t _rm_08003332 = g_cpu.R[0];
    uint32_t _op2_08003332;
    uint32_t _co_08003332;
    _op2_08003332 = _rm_08003332 << 1;
    _co_08003332 = (_rm_08003332 >> 31) & 1u;
    uint32_t _r_08003332;
    _r_08003332 = _op2_08003332;
    arm_set_nzc_logic(_r_08003332, _co_08003332);
    g_cpu.R[3] = _r_08003332;
    g_cpu.R[15] = 0x08003334u;
    runtime_tick(_cyc_08003332);
    /* 08003334  08003334 T adds r3,r3,r0 */
    g_cpu.R[15] = 0x08003334u;
    if (runtime_should_yield()) return;
    if (g_runtime_insn_trace) runtime_insn_fp();
    uint32_t _cyc_08003334 = 1u;
    _cyc_08003334 = 1u;
    uint32_t _rm_08003334 = g_cpu.R[0];
    uint32_t _op2_08003334;
    uint32_t _co_08003334;
    _op2_08003334 = _rm_08003334;
    _co_08003334 = cpsr_c();
    uint32_t _rn_08003334 = g_cpu.R[3];
    uint32_t _r_08003334;
    _r_08003334 = _rn_08003334 + _op2_08003334;
    arm_set_nzcv_add(_rn_08003334, _op2_08003334, _r_08003334);
    g_cpu.R[3] = _r_08003334;
    g_cpu.R[15] = 0x08003336u;
    runtime_tick(_cyc_08003334);
    /* 08003336  08003336 T movs r3,r3,lsl #2 */
    g_cpu.R[15] = 0x08003336u;
    if (runtime_should_yield()) return;
    if (g_runtime_insn_trace) runtime_insn_fp();
    uint32_t _cyc_08003336 = 1u;
    _cyc_08003336 = 1u;
    uint32_t _rm_08003336 = g_cpu.R[3];
    uint32_t _op2_08003336;
    uint32_t _co_08003336;
    _op2_08003336 = _rm_08003336 << 2;
    _co_08003336 = (_rm_08003336 >> 30) & 1u;
    uint32_t _r_08003336;
    _r_08003336 = _op2_08003336;
    arm_set_nzc_logic(_r_08003336, _co_08003336);
    g_cpu.R[3] = _r_08003336;
    g_cpu.R[15] = 0x08003338u;
    runtime_tick(_cyc_08003336);
    /* 08003338  08003338 T mov r1,r12 */
    g_cpu.R[15] = 0x08003338u;
    if (runtime_should_yield()) return;
    if (g_runtime_insn_trace) runtime_insn_fp();
    uint32_t _cyc_08003338 = 1u;
    _cyc_08003338 = 1u;
    uint32_t _rm_08003338 = g_cpu.R[12];
    uint32_t _op2_08003338;
    uint32_t _co_08003338;
    _op2_08003338 = _rm_08003338;
    _co_08003338 = cpsr_c();
    uint32_t _r_08003338;
    _r_08003338 = _op2_08003338;
    g_cpu.R[1] = _r_08003338;
    g_cpu.R[15] = 0x0800333Au;
    runtime_tick(_cyc_08003338);
    /* 0800333A  0800333a T adds r1,r1,#0x8 */
    g_cpu.R[15] = 0x0800333Au;
    if (runtime_should_yield()) return;
    if (g_runtime_insn_trace) runtime_insn_fp();
    uint32_t _cyc_0800333A = 1u;
    _cyc_0800333A = 1u;
    uint32_t _rn_0800333A = g_cpu.R[1];
    uint32_t _r_0800333A;
    _r_0800333A = _rn_0800333A + 0x00000008u;
    arm_set_nzcv_add(_rn_0800333A, 0x00000008u, _r_0800333A);
    g_cpu.R[1] = _r_0800333A;
    g_cpu.R[15] = 0x0800333Cu;
    runtime_tick(_cyc_0800333A);
    /* 0800333C  0800333c T adds r1,r3,r1 */
    g_cpu.R[15] = 0x0800333Cu;
    if (runtime_should_yield()) return;
    if (g_runtime_insn_trace) runtime_insn_fp();
    uint32_t _cyc_0800333C = 1u;
    _cyc_0800333C = 1u;
    uint32_t _rm_0800333C = g_cpu.R[1];
    uint32_t _op2_0800333C;
    uint32_t _co_0800333C;
    _op2_0800333C = _rm_0800333C;
    _co_0800333C = cpsr_c();
    uint32_t _rn_0800333C = g_cpu.R[3];
    uint32_t _r_0800333C;
    _r_0800333C = _rn_0800333C + _op2_0800333C;
    arm_set_nzcv_add(_rn_0800333C, _op2_0800333C, _r_0800333C);
    g_cpu.R[1] = _r_0800333C;
    g_cpu.R[15] = 0x0800333Eu;
    runtime_tick(_cyc_0800333C);
    /* 0800333E  0800333e T movs r2,r4,asr #1 */
    g_cpu.R[15] = 0x0800333Eu;
    if (runtime_should_yield()) return;
    if (g_runtime_insn_trace) runtime_insn_fp();
    uint32_t _cyc_0800333E = 1u;
    _cyc_0800333E = 1u;
    uint32_t _rm_0800333E = g_cpu.R[4];
    uint32_t _op2_0800333E;
    uint32_t _co_0800333E;
    _op2_0800333E = (uint32_t)((int32_t)_rm_0800333E >> 1);
    _co_0800333E = (_rm_0800333E >> 0) & 1u;
    uint32_t _r_0800333E;
    _r_0800333E = _op2_0800333E;
    arm_set_nzc_logic(_r_0800333E, _co_0800333E);
    g_cpu.R[2] = _r_0800333E;
    g_cpu.R[15] = 0x08003340u;
    runtime_tick(_cyc_0800333E);
