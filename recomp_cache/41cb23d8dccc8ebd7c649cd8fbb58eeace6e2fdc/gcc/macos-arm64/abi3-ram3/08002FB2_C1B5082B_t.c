...
// function 0x08002FB2 mode=thumb end=0x08002FCA
...
OVL_EXPORT void func_08002FB2(void) {
    if (g_runtime_fn_entry_hook) g_runtime_fn_entry_hook(0x08002FB2u);
    /* 08002FB2  08002fb2 T ldrb r0,[r0] */
    g_cpu.R[15] = 0x08002FB2u;
    if (runtime_should_yield()) return;
    if (g_runtime_insn_trace) runtime_insn_fp();
    uint32_t _cyc_08002FB2 = 1u;
    _cyc_08002FB2 = 2u;
    uint32_t _base_08002FB2 = g_cpu.R[0];
    uint32_t _off_08002FB2;
    _off_08002FB2 = 0x00000000u;
    uint32_t _ea_08002FB2 = _base_08002FB2 + _off_08002FB2;
    uint32_t _post_08002FB2 = _base_08002FB2 + _off_08002FB2;
    _cyc_08002FB2 += runtime_mem_cycles(_ea_08002FB2, 1u, 0u);
    uint32_t _v_08002FB2;
    _v_08002FB2 = bus_read_u8(_ea_08002FB2);
    g_cpu.R[0] = _v_08002FB2;
    g_cpu.R[15] = 0x08002FB4u;
    runtime_tick(_cyc_08002FB2);
    /* 08002FB4  08002fb4 T movs r0,r0,lsl #1 */
    g_cpu.R[15] = 0x08002FB4u;
    if (runtime_should_yield()) return;
    if (g_runtime_insn_trace) runtime_insn_fp();
    uint32_t _cyc_08002FB4 = 1u;
    _cyc_08002FB4 = 1u;
    uint32_t _rm_08002FB4 = g_cpu.R[0];
    uint32_t _op2_08002FB4;
    uint32_t _co_08002FB4;
    _op2_08002FB4 = _rm_08002FB4 << 1;
    _co_08002FB4 = (_rm_08002FB4 >> 31) & 1u;
    uint32_t _r_08002FB4;
    _r_08002FB4 = _op2_08002FB4;
    arm_set_nzc_logic(_r_08002FB4, _co_08002FB4);
    g_cpu.R[0] = _r_08002FB4;
    g_cpu.R[15] = 0x08002FB6u;
    runtime_tick(_cyc_08002FB4);
