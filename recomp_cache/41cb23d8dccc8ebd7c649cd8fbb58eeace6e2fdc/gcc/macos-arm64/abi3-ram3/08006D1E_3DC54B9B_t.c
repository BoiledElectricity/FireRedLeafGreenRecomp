...
// function 0x08006D1E mode=thumb end=0x08006D56
...
OVL_EXPORT void func_08006D1E(void) {
    if (g_runtime_fn_entry_hook) g_runtime_fn_entry_hook(0x08006D1Eu);
    /* 08006D1E  08006d1e T movs r0,r2,lsl #4 */
    g_cpu.R[15] = 0x08006D1Eu;
    if (runtime_should_yield()) return;
    if (g_runtime_insn_trace) runtime_insn_fp();
    uint32_t _cyc_08006D1E = 1u;
    _cyc_08006D1E = 1u;
    uint32_t _rm_08006D1E = g_cpu.R[2];
    uint32_t _op2_08006D1E;
    uint32_t _co_08006D1E;
    _op2_08006D1E = _rm_08006D1E << 4;
    _co_08006D1E = (_rm_08006D1E >> 28) & 1u;
    uint32_t _r_08006D1E;
    _r_08006D1E = _op2_08006D1E;
    arm_set_nzc_logic(_r_08006D1E, _co_08006D1E);
    g_cpu.R[0] = _r_08006D1E;
    g_cpu.R[15] = 0x08006D20u;
    runtime_tick(_cyc_08006D1E);
    /* 08006D20  08006d20 T adds r0,r0,r2 */
    g_cpu.R[15] = 0x08006D20u;
    if (runtime_should_yield()) return;
    if (g_runtime_insn_trace) runtime_insn_fp();
    uint32_t _cyc_08006D20 = 1u;
    _cyc_08006D20 = 1u;
    uint32_t _rm_08006D20 = g_cpu.R[2];
    uint32_t _op2_08006D20;
    uint32_t _co_08006D20;
    _op2_08006D20 = _rm_08006D20;
    _co_08006D20 = cpsr_c();
    uint32_t _rn_08006D20 = g_cpu.R[0];
    uint32_t _r_08006D20;
    _r_08006D20 = _rn_08006D20 + _op2_08006D20;
    arm_set_nzcv_add(_rn_08006D20, _op2_08006D20, _r_08006D20);
    g_cpu.R[0] = _r_08006D20;
    g_cpu.R[15] = 0x08006D22u;
    runtime_tick(_cyc_08006D20);
    /* 08006D22  08006d22 T movs r0,r0,lsl #2 */
    g_cpu.R[15] = 0x08006D22u;
    if (runtime_should_yield()) return;
    if (g_runtime_insn_trace) runtime_insn_fp();
    uint32_t _cyc_08006D22 = 1u;
    _cyc_08006D22 = 1u;
    uint32_t _rm_08006D22 = g_cpu.R[0];
    uint32_t _op2_08006D22;
    uint32_t _co_08006D22;
    _op2_08006D22 = _rm_08006D22 << 2;
    _co_08006D22 = (_rm_08006D22 >> 30) & 1u;
    uint32_t _r_08006D22;
    _r_08006D22 = _op2_08006D22;
    arm_set_nzc_logic(_r_08006D22, _co_08006D22);
    g_cpu.R[0] = _r_08006D22;
    g_cpu.R[15] = 0x08006D24u;
    runtime_tick(_cyc_08006D22);
    /* 08006D24  08006d24 T ldr r7,[r15,#0xa4] */
    g_cpu.R[15] = 0x08006D24u;
    if (runtime_should_yield()) return;
    if (g_runtime_insn_trace) runtime_insn_fp();
    uint32_t _cyc_08006D24 = 1u;
    _cyc_08006D24 = 2u;
    uint32_t _base_08006D24 = 0x08006D28u & ~3u;
    uint32_t _off_08006D24;
    _off_08006D24 = 0x000000A4u;
    uint32_t _ea_08006D24 = _base_08006D24 + _off_08006D24;
    uint32_t _post_08006D24 = _base_08006D24 + _off_08006D24;
    _cyc_08006D24 += runtime_mem_cycles(_ea_08006D24, 4u, 0u);
    uint32_t _v_08006D24;
    { uint32_t _w = bus_read_u32(_ea_08006D24 & ~3u); uint32_t _rot = (_ea_08006D24 & 3u) * 8u; _v_08006D24 = (_rot == 0u) ? _w : ((_w >> _rot) | (_w << (32u - _rot))); }
    g_cpu.R[7] = _v_08006D24;
    g_cpu.R[15] = 0x08006D26u;
    runtime_tick(_cyc_08006D24);
    /* 08006D26  08006d26 T adds r3,r0,r7 */
    g_cpu.R[15] = 0x08006D26u;
    if (runtime_should_yield()) return;
    if (g_runtime_insn_trace) runtime_insn_fp();
    uint32_t _cyc_08006D26 = 1u;
    _cyc_08006D26 = 1u;
    uint32_t _rm_08006D26 = g_cpu.R[7];
    uint32_t _op2_08006D26;
    uint32_t _co_08006D26;
    _op2_08006D26 = _rm_08006D26;
    _co_08006D26 = cpsr_c();
    uint32_t _rn_08006D26 = g_cpu.R[0];
    uint32_t _r_08006D26;
    _r_08006D26 = _rn_08006D26 + _op2_08006D26;
    arm_set_nzcv_add(_rn_08006D26, _op2_08006D26, _r_08006D26);
    g_cpu.R[3] = _r_08006D26;
    g_cpu.R[15] = 0x08006D28u;
    runtime_tick(_cyc_08006D26);
    /* 08006D28  08006d28 T mov r0,r12 */
    g_cpu.R[15] = 0x08006D28u;
    if (runtime_should_yield()) return;
    if (g_runtime_insn_trace) runtime_insn_fp();
    uint32_t _cyc_08006D28 = 1u;
    _cyc_08006D28 = 1u;
    uint32_t _rm_08006D28 = g_cpu.R[12];
    uint32_t _op2_08006D28;
    uint32_t _co_08006D28;
    _op2_08006D28 = _rm_08006D28;
    _co_08006D28 = cpsr_c();
    uint32_t _r_08006D28;
    _r_08006D28 = _op2_08006D28;
    g_cpu.R[0] = _r_08006D28;
    g_cpu.R[15] = 0x08006D2Au;
    runtime_tick(_cyc_08006D28);
    /* 08006D2A  08006d2a T add r0,r0,r10 */
    g_cpu.R[15] = 0x08006D2Au;
    if (runtime_should_yield()) return;
    if (g_runtime_insn_trace) runtime_insn_fp();
    uint32_t _cyc_08006D2A = 1u;
    _cyc_08006D2A = 1u;
    uint32_t _rm_08006D2A = g_cpu.R[10];
    uint32_t _op2_08006D2A;
    uint32_t _co_08006D2A;
    _op2_08006D2A = _rm_08006D2A;
    _co_08006D2A = cpsr_c();
    uint32_t _rn_08006D2A = g_cpu.R[0];
    uint32_t _r_08006D2A;
    _r_08006D2A = _rn_08006D2A + _op2_08006D2A;
    g_cpu.R[0] = _r_08006D2A;
    g_cpu.R[15] = 0x08006D2Cu;
    runtime_tick(_cyc_08006D2A);
    /* 08006D2C  08006d2c T ldrb r1,[r0] */
    g_cpu.R[15] = 0x08006D2Cu;
    if (runtime_should_yield()) return;
    if (g_runtime_insn_trace) runtime_insn_fp();
    uint32_t _cyc_08006D2C = 1u;
    _cyc_08006D2C = 2u;
    uint32_t _base_08006D2C = g_cpu.R[0];
    uint32_t _off_08006D2C;
    _off_08006D2C = 0x00000000u;
    uint32_t _ea_08006D2C = _base_08006D2C + _off_08006D2C;
    uint32_t _post_08006D2C = _base_08006D2C + _off_08006D2C;
    _cyc_08006D2C += runtime_mem_cycles(_ea_08006D2C, 1u, 0u);
    uint32_t _v_08006D2C;
    _v_08006D2C = bus_read_u8(_ea_08006D2C);
    g_cpu.R[1] = _v_08006D2C;
    g_cpu.R[15] = 0x08006D2Eu;
    runtime_tick(_cyc_08006D2C);
