...
// function 0x08002F98 mode=thumb end=0x08002FA2
...
OVL_EXPORT void func_08002F98(void) {
    if (g_runtime_fn_entry_hook) g_runtime_fn_entry_hook(0x08002F98u);
    /* 08002F98  08002f98 T cmps r0,#0x0 */
    g_cpu.R[15] = 0x08002F98u;
    if (runtime_should_yield()) return;
    if (g_runtime_insn_trace) runtime_insn_fp();
    uint32_t _cyc_08002F98 = 1u;
    _cyc_08002F98 = 1u;
    uint32_t _rn_08002F98 = g_cpu.R[0];
    uint32_t _r_08002F98;
    _r_08002F98 = _rn_08002F98 - 0x00000000u;
    arm_set_nzcv_sub(_rn_08002F98, 0x00000000u, _r_08002F98);
    g_cpu.R[15] = 0x08002F9Au;
    runtime_tick(_cyc_08002F98);
