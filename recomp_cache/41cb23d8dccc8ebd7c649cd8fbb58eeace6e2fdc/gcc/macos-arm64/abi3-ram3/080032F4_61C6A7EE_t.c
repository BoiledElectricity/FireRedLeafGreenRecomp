...
// function 0x080032F4 mode=thumb end=0x0800330C
...
OVL_EXPORT void func_080032F4(void) {
    if (g_runtime_fn_entry_hook) g_runtime_fn_entry_hook(0x080032F4u);
    /* 080032F4  080032f4 T ldr r2,[r13,#0x58] */
    g_cpu.R[15] = 0x080032F4u;
    if (runtime_should_yield()) return;
    if (g_runtime_insn_trace) runtime_insn_fp();
    uint32_t _cyc_080032F4 = 1u;
    _cyc_080032F4 = 2u;
    uint32_t _base_080032F4 = g_cpu.R[13];
    uint32_t _off_080032F4;
    _off_080032F4 = 0x00000058u;
    uint32_t _ea_080032F4 = _base_080032F4 + _off_080032F4;
    uint32_t _post_080032F4 = _base_080032F4 + _off_080032F4;
    _cyc_080032F4 += runtime_mem_cycles(_ea_080032F4, 4u, 0u);
    uint32_t _v_080032F4;
    { uint32_t _w = bus_read_u32(_ea_080032F4 & ~3u); uint32_t _rot = (_ea_080032F4 & 3u) * 8u; _v_080032F4 = (_rot == 0u) ? _w : ((_w >> _rot) | (_w << (32u - _rot))); }
    g_cpu.R[2] = _v_080032F4;
    g_cpu.R[15] = 0x080032F6u;
    runtime_tick(_cyc_080032F4);
