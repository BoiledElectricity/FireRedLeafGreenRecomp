...
// function 0x08006B6A mode=thumb end=0x08006B82
...
OVL_EXPORT void func_08006B6A(void) {
    if (g_runtime_fn_entry_hook) g_runtime_fn_entry_hook(0x08006B6Au);
    /* 08006B6A  08006b6a T adds r4,r0,r1 */
    g_cpu.R[15] = 0x08006B6Au;
    if (runtime_should_yield()) return;
    if (g_runtime_insn_trace) runtime_insn_fp();
    uint32_t _cyc_08006B6A = 1u;
    _cyc_08006B6A = 1u;
    uint32_t _rm_08006B6A = g_cpu.R[1];
    uint32_t _op2_08006B6A;
    uint32_t _co_08006B6A;
    _op2_08006B6A = _rm_08006B6A;
    _co_08006B6A = cpsr_c();
    uint32_t _rn_08006B6A = g_cpu.R[0];
    uint32_t _r_08006B6A;
    _r_08006B6A = _rn_08006B6A + _op2_08006B6A;
    arm_set_nzcv_add(_rn_08006B6A, _op2_08006B6A, _r_08006B6A);
    g_cpu.R[4] = _r_08006B6A;
    g_cpu.R[15] = 0x08006B6Cu;
    runtime_tick(_cyc_08006B6A);
