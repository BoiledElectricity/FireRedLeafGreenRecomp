...
// function 0x081E34FE mode=thumb end=0x081E3514
...
OVL_EXPORT void func_081E34FE(void) {
    if (g_runtime_fn_entry_hook) g_runtime_fn_entry_hook(0x081E34FEu);
    /* 081E34FE  081e34fe T cmps r0,#0x1f */
    g_cpu.R[15] = 0x081E34FEu;
    if (runtime_should_yield()) return;
    if (g_runtime_insn_trace) runtime_insn_fp();
    uint32_t _cyc_081E34FE = 1u;
    _cyc_081E34FE = 1u;
    uint32_t _rn_081E34FE = g_cpu.R[0];
    uint32_t _r_081E34FE;
    _r_081E34FE = _rn_081E34FE - 0x0000001Fu;
    arm_set_nzcv_sub(_rn_081E34FE, 0x0000001Fu, _r_081E34FE);
    g_cpu.R[15] = 0x081E3500u;
    runtime_tick(_cyc_081E34FE);
