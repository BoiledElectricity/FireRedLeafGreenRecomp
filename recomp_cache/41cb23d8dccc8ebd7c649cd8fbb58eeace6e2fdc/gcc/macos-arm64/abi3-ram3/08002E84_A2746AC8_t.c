...
// function 0x08002E84 mode=thumb end=0x08002E96
...
OVL_EXPORT void func_08002E84(void) {
    if (g_runtime_fn_entry_hook) g_runtime_fn_entry_hook(0x08002E84u);
    /* 08002E84  08002e84 T ldr r2,[r0] */
    g_cpu.R[15] = 0x08002E84u;
    if (runtime_should_yield()) return;
    if (g_runtime_insn_trace) runtime_insn_fp();
    uint32_t _cyc_08002E84 = 1u;
    _cyc_08002E84 = 2u;
    uint32_t _base_08002E84 = g_cpu.R[0];
    uint32_t _off_08002E84;
    _off_08002E84 = 0x00000000u;
    uint32_t _ea_08002E84 = _base_08002E84 + _off_08002E84;
    uint32_t _post_08002E84 = _base_08002E84 + _off_08002E84;
    _cyc_08002E84 += runtime_mem_cycles(_ea_08002E84, 4u, 0u);
    uint32_t _v_08002E84;
    { uint32_t _w = bus_read_u32(_ea_08002E84 & ~3u); uint32_t _rot = (_ea_08002E84 & 3u) * 8u; _v_08002E84 = (_rot == 0u) ? _w : ((_w >> _rot) | (_w << (32u - _rot))); }
    g_cpu.R[2] = _v_08002E84;
    g_cpu.R[15] = 0x08002E86u;
    runtime_tick(_cyc_08002E84);
    /* 08002E86  08002e86 T movs r0,r1,lsl #1 */
    g_cpu.R[15] = 0x08002E86u;
    if (runtime_should_yield()) return;
    if (g_runtime_insn_trace) runtime_insn_fp();
    uint32_t _cyc_08002E86 = 1u;
    _cyc_08002E86 = 1u;
    uint32_t _rm_08002E86 = g_cpu.R[1];
    uint32_t _op2_08002E86;
    uint32_t _co_08002E86;
    _op2_08002E86 = _rm_08002E86 << 1;
    _co_08002E86 = (_rm_08002E86 >> 31) & 1u;
    uint32_t _r_08002E86;
    _r_08002E86 = _op2_08002E86;
    arm_set_nzc_logic(_r_08002E86, _co_08002E86);
    g_cpu.R[0] = _r_08002E86;
    g_cpu.R[15] = 0x08002E88u;
    runtime_tick(_cyc_08002E86);
